...
interface ProductDao {
    ...
    @Query("select * from products where food_group in (:foodGroupFilters)" +
            "order by case " +
            ...
            "end asc")
    fun getProductsSortedBy(sortOrder: Int, foodGroupFilters: Array<FoodGroup>): Flow<List<Product>>
